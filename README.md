...
1. [Basic](https://github.com/trioXech/python-core/blob/master/1.Basic/README.md)
...
2. [More Control Flow Tools](https://github.com/trioXech/python-core/blob/master/10.VirtualEnvironmentsAndPackages/README.md)
    - 2.1. if Statements
    - 2.2. for Statements
