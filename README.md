...
1. [Basic](https://github.com/trioXech/python-core/blob/durjoi/1.Basic/1.Basic.md)
    - 1.1. Numbers
    - 1.2. Strings
    - 1.3. Lists
2. [More Control Flow Tools](https://github.com/trioXech/python-core/blob/durjoi/10.VirtualEnvironmentsAndPackages/10.VirtualEnvironmentsAndPackages.md)
    - 2.1. if Statements
    - 2.2. for Statements
